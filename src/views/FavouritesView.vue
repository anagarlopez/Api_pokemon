<template>
    <div>
      ...
      <div>
        ...
        <div class="poke-container">
          <div class="card pokemon grid-poke rounded px-2 py-1" v-for="pokemon in favoritos" :key="pokemon.id">
              ...
              <div class="card__face card__face--back card-back">
                <div class="pokemon">
                  ...
                  <p class="ability text-secondary">
                    <div v-for="ability in pokemon.ability" :key="ability">{{ ability }}</div>
                  </p>
                ...
                <p class="nature">
                  <div v-for="nature in pokemon.nature" :key="nature">{{ nature }}</div>
                </p>
  ...
  const { favoritos } = toRefs(store.state);
  
  // Actualiza la referencia local cuando la tienda cambia
  onMounted(() => {
    // Asegúrate de actualizar la referencia local
    // cuando la tienda cambia, ya que favoritos es una propiedad reactiva
    favoritos.value = store.favoritos;
  });
